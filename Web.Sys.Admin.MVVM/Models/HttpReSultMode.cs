...
namespace Web.Sys.Admin.Models
{
    ...
    public class HttpReSultMode
    {
        ...
        /// <returns></returns>
        public static HttpReSultMode GetReSultMode(int _code, string _msg, string _data)
        {
            HttpReSultMode info = new HttpReSultMode();
            info.code = _code;
            info.msg = _msg;
            info.data = _data;
            return info;
    ...
    { /// <summary>
        ...
        /// <param name="_data">数据</param>
        /// <returns></returns>
        public static HttpReSultMode<T> GetReSultMode(int _code, string _msg, T _data)
        {
            HttpReSultMode<T> info = new HttpReSultMode<T>();
            info.code = _code;
            info.msg = _msg;
            info.data = _data;
            return info;
